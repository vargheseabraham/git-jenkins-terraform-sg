  ...
  <body>
    <center>
      <table border="1" width="800">
        <tr><td>
          <h3><u><center>NORAM Automation Initiative</center></u></h3>
          ...
          <h5><u><i>Workload Automation:</i></u></h5> Workload automation is the practice of using software to schedule, initiate, run and manage tasks related to business processes and transactions
          <h5><u><i>AI&ML Driven Solutions:</i></u></h5> Artificial intelligence (AI), sometimes called machine intelligence, is intelligence demonstrated... These sub-fields are based on technical considerations, such as particular goals (e.g. "robotics" or "machine learning"), the use of particular.
        </td></tr>
      </table>
    </center>
  </body>
